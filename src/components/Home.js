      ...
      <div className="overlay" id="home">
        <section className="intro"> 
          ...
          <li>
            ...
            style={{margin: '2em'}}
            />
            <p style={{color:'rgb(233, 49, 49)'}}>youtube/SUNRISE study</p>
            </li>
            <li>
            <AnimatedSocialIcon
            brandName="twitter"
            ...
            style={{margin: '2em'}}
            />
            <p style={{color:'rgb(243, 119, 42)'}}>instagram/Sunrise</p>
            </li>
          </ul>
          </div>
          <div className='follow'>
          <img src={followlogo} height="300px" width="300px" alt="followlogo"/>
          </div>
          </div>
          </div>
